...
function DisplayCard() {
    return (
        <div className="bg-main-black text-white p-20" style={{ borderRadius: '2.3rem' }}>
            <div className="border-b-[1px] border-highlighted-text flex">
                <div className="w-1/2 space-y-12 pb-16">
                    <div className="w-20 h-20 drop-shadow-md bg-main-purple text-white rounded-full flex items-center justify-center"><i className="fa-regular fa-envelope-open text-2xl"></i></div>
                    <p className="text-6xl">Keep up with the latest</p>
            ...
            <div className="pt-20 px-2 flex justify-between">
